...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/3004
    links:
    - https://yukicoder.me/problems/no/3004
  bundledCode: "#line 1 \"test/yukicoder/3004.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/3004\"\
    ...
    \     }\n        return res;\n    }\n};\n#line 4 \"test/yukicoder/3004.test.cpp\"\
    ...
    \    solve();\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/3004\"\n#include \"math/factorial_large.hpp\"\
    \n#include <atcoder/modint>\nusing mint = atcoder::modint998244353;\nfactorial_large<mint>\
    \ fac;\nvoid solve() {\n    LL(k);\n    ll sum = 0;\n    mint ans = 1;\n    rep(i,\
    \ k) {\n        LL(l, m);\n        sum += l * m;\n        ans *= fac.fac(m);\n\
    \        ans *= fac.fac(l).pow(m);\n    }\n    ans = fac.fac(sum) / ans;\n   \
    \ print(ans.val());\n}\nint main() {\n    ios::sync_with_stdio(false);\n    std::cin.tie(nullptr);\n\
  ...
  requiredBy: []
  timestamp: '2025-01-17 23:40:55+09:00'
