...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/2304.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2304\"\
    ...
    \   // \\__/ -> \\___\n    // f(x) <- min[y<=x]f(y)\n    void clear_right() {\
    \ R = {inf}; }\n    // \\__/ -> __/\n    // f(x) <- min[y>=x]f(y)\n    void clear_left()\
    \ { L = {-inf}; }\n};\n#line 4 \"test/yukicoder/2304.test.cpp\"\nvoid solve()\
    \ {\n    INT(n);\n    vl a(n);\n    input(a);\n    ranges::sort(a);\n    SlopeTrick\
    \ v;\n    for(auto ai : a) {\n        v.shift(1);\n        v.clear_right();\n\
  ...
  requiredBy: []
  timestamp: '2025-03-15 14:57:47+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/yukicoder/2304.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/2304.test.cpp
- /verify/test/yukicoder/2304.test.cpp.html
